          ...
          children: [
            FutureBuilder<DashboardResponse>(
              ...
              builder: (context, snap) {
                ...
                return snapWidgetHelper(snap, loadingWidget: ProviderDashboardShimmer(), errorBuilder: (error) {
                  return NoDataWidget(
                    title: error,
                    retryText: languages.tryAgain,
                    onRetry: () {
            ...
            Observer(builder: (context) => ProviderDashboardShimmer().visible(appStore.isLoading))
          ],
        ),
      ),
    );
