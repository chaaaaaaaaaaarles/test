...
class ServiceAddressesScreenState extends State<ServiceAddressesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<AddressResponse>>(
        future: future,
        builder: (context, snap) {
          if (snap.hasData) {
            if (snap.data.validate().isEmpty) return BackgroundComponent(text: languages.noServiceAddressTitle, subTitle: languages.noServiceAddressSubTitle);
          ...
          return snapWidgetHelper(
            ...
            errorBuilder: (p0) {
              return BackgroundComponent(text: p0);
            },
          );
        },
      ),
