            ...
            children: [
              ...
              RichTextWidget(
                ...
                list: [
                  ...
                  TextSpan(
                    text: isCommissionTypePercent(commission.type) ? '${commission.commission.validate()}%' : '${isCurrencyPositionLeft ? appStore.currencySymbol: ""}${commission.commission.validate()}${isCurrencyPositionRight ? appStore.currencySymbol: ""}',
